...
url = "http://openapi.molit.go.kr:8081/OpenAPI_ToolInstallPackage/"\
      +"service/rest/RTMSOBJSvc/getRTMSDataSvcAptRent?serviceKey={}&LAWD_CD={}&DEAL_YMD={}".format(ServiceKey,LAWD_CD,DEAL_YMD)
############################# 엘라스틱서치에 저장(함수) #######################################
