...
#  연립다세대 전월세 신고정보 자료 다운(국토교통부API).
#  Dwon File Type : JSON(for elastic Search)
#  Reference
#    : \0.reference\PDF\연립다세대_전월세_신고정보_조회_기술문서(rowHouseRentData).pdf
#    : \0.reference\HWP\연립다세대_전월세_신고정보_조회_기술문서.hwp

# index 정의
lv_index    = "api_real_estate_row_house_rent_data"
#  param 정의
...
url = "http://openapi.molit.go.kr:8081/OpenAPI_ToolInstallPackage/"\
      +"service/rest/RTMSOBJSvc/getRTMSDataSvcRHRent?serviceKey={}&LAWD_CD={}&DEAL_YMD={}".format(ServiceKey,LAWD_CD,DEAL_YMD)
############################# 엘라스틱서치에 저장(함수) #######################################
